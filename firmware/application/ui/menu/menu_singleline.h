...
#define MENU_SINGLELINE_SETTING_METADATA_HIDE_LABEL 0
#define MENU_SINGLELINE_SETTING_METADATA_SHOW_LABEL 1
...
#define MENU_SINGLELINE_SETTING_METADATA_MODE_CHUNKY_PARTY 0x03
// Don't enable or use these two, done by setting number of options.
#define MENU_SINGLELINE_SETTING_METADATA_MODE_PARTY_SINGLE 0x04
#define MENU_SINGLELINE_SETTING_METADATA_MODE_STATIC 0x05
// Set to last option + 1
#define MENU_SINGLELINE_SETTING_METADATA_MODE_NUMBER_OF_OPTIONS (MENU_SINGLELINE_SETTING_METADATA_MODE_CHUNKY_PARTY + 1)
