...
#define MENU_SINGLELINE_SETTING_METADATA_MODE_CHUNKY_PARTY 0x05
#define MENU_SINGLELINE_SETTING_METADATA_MODE_LAST_OPTION MENU_SINGLELINE_SETTING_METADATA_MODE_CHUNKY_PARTY
